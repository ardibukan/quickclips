...
const Hero: React.FC<HeroProps> = ({ navigate }) => {
  return (
    <section       
      className="relative min-h-screen container mx-auto px-6 pt-24 pb-12 text-center bg-[url('https://lh3.googleusercontent.com/SpF9hIf_C3KSo-xElVbNF768qUJtb4TNoXTczjyxdH9BSUNnNaedlC7QYq6d9C8YGVnEfSjDdvC3hR4p81UijHFgLoqWqqRPQ70lpnJB50OAAot0iw=w1440')] bg-cover bg-center bg-no-repeat"
      >
